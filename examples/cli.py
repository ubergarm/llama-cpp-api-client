...
async def main():
    ...
    system_prompt = "You are an experienced Python software developer using Linux. Assist the user by providing high quality Python code including comments and modern Python 3 static typing."
    # user_prompt = "Write an example app using rich.layout panels. It should accept user input on the botom panel and print it to the top panel."
    user_prompt = """
Refactor the following python library into a proper Class with member functions and move the globals into member variables.
```python
import asyncio
import json
